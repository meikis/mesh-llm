...
impl SkippyModelHandle {
    ...
    pub(crate) fn load_with_hooks(
        ...
        let binding = embedded_openai_backend(EmbeddedOpenAiArgs {
            ...
            draft_self_layers: embedded_args.draft_self_layers,
            ...
            downstream_wire_condition: WireCondition::new(
                embedded_args.downstream_wire_delay_ms,
                embedded_args.downstream_wire_mbps,
            )?,
