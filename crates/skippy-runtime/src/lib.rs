...
impl RuntimeConfig {
    ...
    fn as_raw(&self) -> Result<RawRuntimeConfigParts> {
        ...
        Ok(RawRuntimeConfigParts {
            raw: RawRuntimeConfig {
                ...
                has_mmap_override: self.mmap.is_some() || !self.use_mmap,
    ...
    pub fn native_log_summary(&self) -> String {
        ...
        let n_ubatch = self.n_ubatch.unwrap_or(LLAMA_SERVER_DEFAULT_N_UBATCH);
        format!(
            "stage_index={} layers={}..{} ctx={} lanes={} branch_sequences={} n_batch={} n_ubatch={} n_gpu_layers={} mmap={} mlock={} backend={} cache_k={} cache_v={} flash_attn={:?} load_mode={:?} use_mmap={} use_mmap_prefetch={} use_mmap_buffer={} include_embeddings={} include_output={} filter_tensors_on_load={} glm_dsa_policy={}",
            self.stage_index,
            self.layer_start,
            self.layer_end,
            self.ctx_size,
...
mod tests {
    ...
    use super::{
        ...
        GGML_TYPE_F16, GGML_TYPE_Q4_0, GGML_TYPE_Q8_0, GlmDsaPolicyConfig,
        LLAMA_SERVER_DEFAULT_N_BATCH, LLAMA_SERVER_DEFAULT_N_UBATCH, ModelInfo,
        NativeLogAggregator, NativeLogEvent, NativeMtpDraft, RuntimeConfig, RuntimeLoadMode,
        SKIPPY_UNIFIED_KV_DEFAULT_N_BATCH, SamplingConfig, StageModel, StageSession, Status,
        TensorRole, flush_native_log_writer, format_skippy_error, ngram_simple_draft,
